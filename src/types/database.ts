...
// =============================================
// CUSTOM TYPES (added manually)
// =============================================

// Challenge types (convenience aliases from Database)
...
export type ChallengeCheckin = Database["public"]["Tables"]["challenge_checkins"]["Row"];
...
export type ChallengePhase = Database["public"]["Tables"]["challenge_phases"]["Row"];
...
export type ParticipantAchievement = Database["public"]["Tables"]["participant_achievements"]["Row"];

// Extended ChallengeParticipant for V2
...
// Challenge with V2 relations
export type ChallengeWithPhasesAndGoals = Challenge & {
  phases: (ChallengePhase & {
    goals: ChallengeGoal[];
  })[];
  goals: ChallengeGoal[]; // goals without phase (direct)
};
...
export type OrgRole = "admin" | "nutri" | "receptionist" | "patient";
...
export type NutriAvailability = Database["public"]["Tables"]["nutri_availability"]["Row"];
export type TimeBlock = Database["public"]["Tables"]["nutri_time_blocks"]["Row"];
export type NutriTimeBlock = TimeBlock;
...
export type AnamnesisReport = Database["public"]["Tables"]["anamnesis_reports"]["Row"];
...
export type MealContent = Database["public"]["Tables"]["meal_contents"]["Row"];
export type AnthropometryAssessment = Database["public"]["Tables"]["anthropometry_assessments"]["Row"];

// Temporary types for tables that may not exist in remote yet
// TODO: Remove after migrations are synced
export type CustomMeasurementType = {
  id: string;
  nutri_id: string;
  name: string;
  unit: string;
