...
interface WizardAnthropometryFormProps {
  patientGender: string | null;
  patientBirthDate: string | null;
  initialData?: WizardAnthropometryData;
  onSubmit: (data: WizardAnthropometryData) => void;
  formId: string;
}

export function WizardAnthropometryForm({
  patientGender,
  patientBirthDate,
  initialData,
  onSubmit,
  formId,
}: WizardAnthropometryFormProps) {
  ...
  const calculatedMetrics = useMemo(() => {
    ...
    const skinfolds = {
      ...
      subscapular: subscapularSkinfold
        ...
        : null,
      midaxillary: midaxillarySkinfold
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    onSubmit({
      ...
      triceps_skinfold: parseNum(tricepsSkinfold),
      subscapular_skinfold: parseNum(subscapularSkinfold),
      suprailiac_skinfold: parseNum(suprailiacSkinfold),
      abdominal_skinfold: parseNum(abdominalSkinfold),
      thigh_skinfold: parseNum(thighSkinfold),
      chest_skinfold: parseNum(chestSkinfold),
      midaxillary_skinfold: parseNum(midaxillarySkinfold),
      neck_circumference: parseNum(neckCircumference),
      chest_circumference: parseNum(chestCircumference),
      waist_circumference: parseNum(waistCircumference),
      abdomen_circumference: parseNum(abdomenCircumference),
      hip_circumference: parseNum(hipCircumference),
      right_arm_circumference: parseNum(rightArmCircumference),
      left_arm_circumference: parseNum(leftArmCircumference),
      right_forearm_circumference: parseNum(rightForearmCircumference),
      left_forearm_circumference: parseNum(leftForearmCircumference),
      right_thigh_circumference: parseNum(rightThighCircumference),
      left_thigh_circumference: parseNum(leftThighCircumference),
      right_calf_circumference: parseNum(rightCalfCircumference),
      left_calf_circumference: parseNum(leftCalfCircumference),
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setRightThighCircumference(e.target.value)
                  }
                  placeholder="Ex: 55.0"
                />
              </div>
