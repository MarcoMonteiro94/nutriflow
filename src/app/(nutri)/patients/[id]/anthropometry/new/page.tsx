...
import { AnthropometryForm } from "../_components/anthropometry-form";
...
export default async function NewAnthropometryPage({ params }: PageProps) {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Registre a avaliação antropométrica de {patient.full_name}.
          </p>
        </div>
      </div>
